...
public class DriverClasifico {
    ...
    public void llenarClasificaciones() {
        ...
        llenarArrayArticulos(articulosOrganica, tempClas);
        ...
        llenarArrayArticulos(articulosMetal, tempClas);
        clasificacionesBasura.add(tempClas);
